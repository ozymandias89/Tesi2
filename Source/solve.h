...
/**
 ...
 Environment of the problem, problem and index of fractional variable selected and verbose
 \return none
 */
...
/**
 Auxiliary method that remove constraint and update data structures
